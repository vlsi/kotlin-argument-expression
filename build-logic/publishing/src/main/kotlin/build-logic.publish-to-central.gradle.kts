...
publishing {
    publications.configureEach<MavenPublication> {
        ...
        pom {
            ...
            url.set("https://github.com/vlsi/kotlin-argument-expression")
            licenses {
                license {
                    name.set("Apache-2.0")
            ...
            issueManagement {
                ...
                url.set("https://github.com/vlsi/kotlin-argument-expression/issues")
            }
            scm {
                connection.set("scm:git:https://github.com/vlsi/kotlin-argument-expression.git")
                developerConnection.set("scm:git:https://github.com/vlsi/kotlin-argument-expression.git")
                url.set("https://github.com/vlsi/kotlin-argument-expression")
                tag.set("HEAD")
            }
        }
